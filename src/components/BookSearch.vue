<template>
<table class="table table-primary" style="width:75%" align="center">
  <tbody>
	<tr>
	...
	<tr>
		...
		<td align="center">
            <div class="col-sm-7">
		<input class="form-control" type="number" id="bookId" v-model="bookId">
            </div>
		</td>
	</tr>
	<tr>
		...
		<td align="center">
            <div class="col-sm-7">
		<input class="form-control" type="text" id="authorName" v-model="authorName">
            </div>
		</td>
	</tr>
  </tbody>
</table>
<button id="search_plan" class="btn btn-primary" type="button" @click="searchBooks">検索する</button>
<hr>
<table class="table table-striped" style="width:75%" align="center">
  <tbody>
	...
	<tr v-for="(book, key) in responsedbooks" v-bind:key="key">
